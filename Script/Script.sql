...
select *from Registro order by FechaIngreso d

select *from Registro order by convert(FechaIngreso) desc;

select convert(varchar(15),FechaIngreso, 103) As FechaIngreso, Nombre, Iphone, AppleWatch, Samsung, GB, Color, IMEI1, IMEI2, Entrada, Salida, Observacion  from Registro Order By FechaIngreso asc
